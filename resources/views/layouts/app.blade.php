...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('favicon-mhk.png') }}?v={{ filemtime(public_path('favicon-mhk.png')) }}">
    <link rel="shortcut icon" type="image/png" href="{{ asset('favicon-mhk.png') }}?v={{ filemtime(public_path('favicon-mhk.png')) }}">
    ...
    <link rel="stylesheet" href="{{ asset('css/type-system.css') }}?v={{ filemtime(public_path('css/type-system.css')) }}">
</head>
