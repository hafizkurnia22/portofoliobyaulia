            ...
            <div class="admin-table-card" data-aos="fade-up" data-aos-delay="400">
                <div class="admin-management-layout">
                    ...
                    <div class="tab-pane fade {{ $activeTab == 'dashboard' ? 'show active' : '' }}"
                        ...
                        @php
                            $statistikRingkasan = [
                                ['icon' => 'bi-briefcase-fill', 'nilai' => $totalPengalaman, 'label' => 'Total Pengalaman'],
                                ['icon' => 'bi-kanban-fill', 'nilai' => $totalProject, 'label' => 'Total Project'],
                                ['icon' => 'bi-award-fill', 'nilai' => $totalSertifikasi, 'label' => 'Total Sertifikasi'],
                                ['icon' => 'bi-bar-chart-fill', 'nilai' => $totalSkill, 'label' => 'Total Skill'],
                                ['icon' => 'bi-ui-checks-grid', 'nilai' => $totalTryoutSoal, 'label' => 'Total Soal'],
                                ['icon' => 'bi-journal-bookmark-fill', 'nilai' => $totalTryoutMateri, 'label' => 'Materi Ujian'],
                                ['icon' => 'bi-people-fill', 'nilai' => $totalTryoutPeserta, 'label' => 'Peserta Tryout'],
                                ['icon' => 'bi-clock-history', 'nilai' => $totalTryoutRiwayat, 'label' => 'Riwayat Tryout'],
                            ];
                        @endphp
                        <div class="row g-4 mb-4">
                            @foreach ($statistikRingkasan as $index => $statistik)
                                <div class="col-xl col-md-6" data-aos="fade-up" data-aos-delay="{{ 100 + ($index * 100) }}">
                                    <div class="admin-stat-card">
                                        <i class="bi {{ $statistik['icon'] }}"></i>
                                        <div>
                    ...
                    <div class="tab-pane fade {{ $activeTab == 'master-soal' ? 'show active' : '' }}"
                        ...
                        <div class="admin-table-header" data-aos="fade-right">
                            ...
                            <div class="admin-table-actions">
                                <a href="{{ url('/admin/tryout/pengaturan') }}" class="btn-admin-setting">
